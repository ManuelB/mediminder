package de.incentergy.mediminder.odata;
...
public class JpaODataServiceFactory extends ODataJPAServiceFactory {
	...
	public ODataJPAContext initializeODataJPAContext() throws ODataJPARuntimeException {
		...
		try {
			...
			EntityManager entityManager = (EntityManager) initialContext.lookup("java:/arzneiMobilEntityManager");
			...
			EntityManagerFactory entityManagerFactory = (EntityManagerFactory) initialContext
					.lookup("java:/arzneiMobilEntityManagerFactory");
			oDataJPAContext.setEntityManagerFactory(entityManagerFactory);
			oDataJPAContext.setPersistenceUnitName("arznei-mobil");
	...
	public <T extends ODataCallback> T getCallback(final Class<T> callbackInterface) {
		if (callbackInterface == ODataDebugCallback.class) {
