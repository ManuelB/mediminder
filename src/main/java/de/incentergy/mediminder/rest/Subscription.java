...
public class Subscription {
    ...
    public void post(
            de.incentergy.mediminder.entities.Subscription subscription) {
     ...
     * 
     * curl -X POST --data "Jo Digga" http://localhost:8080/mediminder/resources/subscription/BNuxXaLiJf9prZ2ku6822ufyLIEk0lKOjV79dETfYDYwLqgG9BN7oQrAQjlHcLP5RGF9LR9B0sRnL9CLROYVgqs=/send
     *
     * @param key
     * @param payloadString
    ...
    public void send(@PathParam("key") String key, String payloadString)
        ...
        de.incentergy.mediminder.entities.Subscription subscription = em.find(
                de.incentergy.mediminder.entities.Subscription.class, key);
        ...
        // Aktuelles Problem: http://stackoverflow.com/questions/29700288/bouncycastle-1-51-loading-in-war-on-wildfly-8-0

        // Create a notification with the endpoint, userPublicKey from the
        // subscription and a custom payload
        notification = new Notification(subscription.getEndpoint(),
                subscription.getUserPublicKey(), subscription.getAuthAsBytes(),
                payload);
        ...
        pushService.setGcmApiKey(
                "AAAAs7W-OzA:APA91bFWYTrFqi3hipzGyA1hNKNnlctSLeIo378ofySoOia9FaRiYffjbR5p9Qg1jU0GjasywWl73fOKehnDtElrFKDqi_aE42C3IZvYBGy6U_phVgut33TwO8ds6yZyLRORMqI6Uwf5");
